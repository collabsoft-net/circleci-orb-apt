...
echo "Running DC App Performance Tookit with the following arguments: 'dcdx apt report --type performance --resultsDir1 /tmp/results/run1 --resultsDir2 /tmp/results/run2 --outputDir /tmp/results/ --ts performance -y'"
...
if [ "$PRODUCT" == "bamboo" ];
then
  echo "Running DC App Performance Tookit with the following arguments: 'dcdx apt report --type scalability --product ${PRODUCT} --resultsDir1 /tmp/results/run1 --resultsDir2 /tmp/results/run2 --resultsDir3 /tmp/results/run3 --outputDir /tmp/results/ --ts scalability -y'"
  ...
  echo "Running DC App Performance Tookit with the following arguments: 'dcdx apt report --type scalability --product ${PRODUCT} --resultsDir1 /tmp/results/run3 --resultsDir2 /tmp/results/run4 --resultsDir3 /tmp/results/run5 --outputDir /tmp/results/ --ts scalability -y'"
